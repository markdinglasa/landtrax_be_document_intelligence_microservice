...
import CollectionReceiptEntity from './collection-receipt-entity';
...
export default class CollectionEntity extends BaseEntity {
  ...
  @OneToMany(() => CollectionReceiptEntity, (receipt) => receipt.collection, {
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE',
    cascade: true,
  })
  @JoinColumn({ name: 'CollectionId' })
  collectionReceipts?: CollectionReceiptEntity[];
